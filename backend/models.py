...
class Company(Base):
    ...
    research: Mapped["Research"] = relationship("Research", back_populates="company", uselist=False)
    messages: Mapped[list["Message"]] = relationship("Message", back_populates="company")
    evidence_events: Mapped[list["EvidenceEvent"]] = relationship("EvidenceEvent", back_populates="company")
...
class Message(Base):
    ...
    company: Mapped["Company"] = relationship("Company", back_populates="messages")
...
class EvidenceEvent(Base):
    ...
    company: Mapped["Company"] = relationship("Company", back_populates="evidence_events")
